/* vc4.h -- Header file for VC4 opcode and register tables.
...
/* VC4 core Registers :
   The enums are used as indices to VC4 registers table (vc4_regtab).
...
/* VC4 processor registers and special registers :
   The enums are used as indices to VC4 processor registers table
   (vc4_pregtab). Therefore, order MUST be preserved.  */
...
typedef enum
  {
    VC4_R_REGTYPE,    /* r<N>      */
    VC4_RP_REGTYPE,   /* reg pair  */
    VC4_P_REGTYPE     /* Processor register  */
  }
reg_type;
...
/* VC4 operand types:The operand types correspond to instructions operands.*/
...
#define FMT_VC4       (FMT_1 | FMT_2 | FMT_3 | FMT_4 | FMT_5)
...
/* The following fields are required only by VC4-assembler.  */
#ifdef TC_VC4
...
/* VC4 opcode table.  */
extern const inst vc4_instruction[];
extern const unsigned int vc4_num_opcodes;
#define NUMOPCODES vc4_num_opcodes

/* VC4 operands table.  */
extern const operand_entry vc4_optab[];
extern const unsigned int vc4_num_optab;

/* VC4 registers table.  */
extern const reg_entry vc4_regtab[];
extern const unsigned int vc4_num_regs;
#define NUMREGS vc4_num_regs

/* VC4 register pair table.  */
extern const reg_entry vc4_regptab[];
extern const unsigned int vc4_num_regps;
#define NUMREGPS vc4_num_regps

/* VC4 processor registers table.  */
extern const reg_entry vc4_pregtab[];
extern const unsigned int vc4_num_pregs;
#define NUMPREGS vc4_num_pregs

/* VC4 processor registers - 32 bit table.  */
extern const reg_entry vc4_pregptab[];
extern const unsigned int vc4_num_pregps;
#define NUMPREGPS vc4_num_pregps

/* VC4 trap/interrupt table.  */
extern const trap_entry vc4_traps[];
extern const unsigned int vc4_num_traps;
#define NUMTRAPS vc4_num_traps

/* VC4 CC - codes bit table.  */
extern const char * vc4_b_cond_tab[];
extern const unsigned int vc4_num_cc;
#define NUMCC vc4_num_cc;


/* Table of instructions with no operands.  */
extern const char * vc4_no_op_insn[];
...
#define IS_INSN_TYPE(TYPE)              \
  (VC4_INS_TYPE (instruction->flags) == TYPE)
