...
START_RELOC_NUMBERS(elf_vc4_reloc_type)
  ...
  RELOC_NUMBER (R_VC4_IMM5_1,        9)
  RELOC_NUMBER (R_VC4_IMM5_2,        10)
  RELOC_NUMBER (R_VC4_IMM6,          11)
  RELOC_NUMBER (R_VC4_IMM6_MUL4,     12)
  RELOC_NUMBER (R_VC4_IMM11,         13)
  RELOC_NUMBER (R_VC4_IMM12,         14)
  RELOC_NUMBER (R_VC4_IMM16,         15)
  RELOC_NUMBER (R_VC4_IMM23,         16)
  RELOC_NUMBER (R_VC4_IMM27,         17)
  RELOC_NUMBER (R_VC4_IMM32,         18)
  RELOC_NUMBER (R_VC4_IMM32_2,       19)
